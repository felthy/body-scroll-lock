...
const allowOverscroll = el => locks.some(lock => lock.targetElement === el && lock.options.allowOverscroll);
...
const handleStartScroll = (event, targetElement) => {
...
export const addBodyElementLockListener = (onLock, onUnlock) => {
  bodyElementLockListeners = [...bodyElementLockListeners, { onLock, onUnlock }];
};

export const removeBodyElementLockListener = (onLock, onUnlock) => {
  bodyElementLockListeners = bodyElementLockListeners.filter(listener => onLock !== listener.onLock && onUnlock !== listener.onUnlock);
};
